...
namespace gabr
{
    public partial class design4x4 : Form
    {
        public design4x4()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (textBox4.Text == "0" && textBox8.Text == "0" && textBox9.Text == "0" && textBox16.Text != "0" || textBox3.Text == "0" && textBox7.Text == "0" && textBox10.Text == "0" && textBox15.Text != "0" || textBox2.Text == "0" && textBox6.Text == "0" && textBox11.Text == "0" && textBox14.Text != "0" || textBox1.Text == "0" && textBox5.Text == "0" && textBox12.Text == "0" && textBox13.Text != "0")
            {
            ...
            sol4 sol4x4 = new sol4(num1, num2, num3, num4, num5, num6, num7, num8, num9,
