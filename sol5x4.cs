...
namespace gabr
{
 ...
 double num20)
        ...
        p:
            if (num1 != 0 && num1 != 1)
            {
                label5.Text = "R1/" + num1+" , -" + num2 + "R1+R2->R2";
                label6.Text = "-" + num3 + "R1+R3->R3, -" + num4 + "R1+R4->R4";
                num5 = 1 / num1 * num5;
            ...
            else if (num1 == 1)
            {
                ...
                label5.Text = "Done";
                label6.Text = "-" + num2 + "R1+R2->R2, -" + num3 + "R1+R3->R3, -" + num4 + "R1+R4->R4";
                label12.Text = num5.ToString();
                label19.Text = num12.ToString();
                label20.Text = num13.ToString();
                label24.Text = num20.ToString();
            ...
            {
                label5.Text = "interchanging R1,R2 then R1/" + num2 + "Done";
                label6.Text = "-" + num3 + "R1+R3->R3, -" + num4 + "R1+R4->R4";
                double enum1 = num1;
                double enum2 = num5;
                double enum3 = num12;
        ...
        y:
            ...
            {
                label5.Text = "R1/" + num1 + " , -" + num2 + "R1+R2->R2";
                label6.Text = "Done, " + num4 + "R1+R4->R4";
                label9.Text = num3.ToString();
                label14.Text = num7.ToString();
                label17.Text = num10.ToString();
                label22.Text = num15.ToString();
        ...
        z:
            ...
            {
                label5.Text = "R1/" + num1 + " , -" + num2 + "R1+R2->R2";
                label6.Text = "-" + num3 + "R1+R3->R3, Done";
                label8.Text = num4.ToString();
                label15.Text = num8.ToString();
                label16.Text = num9.ToString();
                label23.Text = num16.ToString();
        ...
        b:
            ...
            {
                label98.Text = "Done";
                label99.Text = "-" + num7 + "R2+R3->R3, -" + num8 + "R2+R4->R4";
            ...
            {
                label98.Text = "interchanging R2,R3 then R2/" + num7;
                label99.Text = "-" + num6 + "R2+R3->R3, -" + num8 + "R2+R4->R4";
                double numx6 = num6;
                double numx7 = num11;
                double numx8 = num14;
                double numx9 = num19;
        ...
        x2:
            ...
            {
                label98.Text = "R2/" + num6;
                label99.Text = "Done" + num8 + "R2+R4->R4";
        ...
        x3:
            ...
            {
                label98.Text = "R2/" + num6;
                label99.Text = "-" + num7 + "R2+R3->R3, Done";
                label30.Text = num4.ToString();
                label31.Text = num8.ToString();
                label38.Text = num9.ToString();
                label39.Text = num16.ToString();
        ...
        k:
            ...
            {
                label100.Text = "interchanging R3,R4 then R3/" + num9;
                label101.Text = "-" + num10 + "R3+R4->R4";
                double xnum1 = num10;
                double xnum2 = num15;
                double xnum3 = num18;
                double xnum4 = num9;
